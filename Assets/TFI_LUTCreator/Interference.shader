Shader "TFI_LUTCreator/Interference"
{
    Properties
    {
        _TopLayerIOR("IOR of Top Layer, ",Float) = 1.0
        _MiddleLayerIOR("IOR of MiddleLayer",Float) = 1.33
        _MiddleLayerThickness("Thickness of Middle Layer",Float) = 500
        ...
        [Toggle] _BottomLayerSwitch("Use Color",Float) = 0
        _BottomLayerBaseColor("BottomLayer BaseColor",Color) = (1,1,1,1)
        _BottomLayerEdgeTint("BottomLayer EdgeTint",Color) = (1,1,1,1)
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float thickness = _MiddleLayerThickness;
